        ...
        <div className="w-full max-w-[calc(100%-62px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[900px] lg:w-[900px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-accent backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
          <div className="flex justify-center items-center">
            ...
            <div className="pl-3 sm:pl-4 md:pl-5 lg:pl-5 justify-start items-start hidden sm:flex flex-row gap-2 sm:gap-3 md:gap-4 lg:gap-4">
              <div className="flex justify-start items-center">
                <div className="flex flex-col justify-center text-primary text-xs md:text-[13px] font-medium leading-[14px] font-sans">
          ...
          <div className="h-6 sm:h-7 md:h-8 flex justify-start items-start gap-2 sm:gap-3">
            <div className="px-2 sm:px-3 md:px-[14px] py-1 sm:py-[6px] bg-accent shadow-[0px_1px_2px_rgba(55,50,47,0.12)] overflow-hidden rounded-full flex justify-center items-center">
              <div className="flex flex-col justify-center text-primary text-xs md:text-[13px] font-medium leading-5 font-sans">
